...
const getVideoOfUser = async (req, res) => {
    ...
    try {
        const video = await videosService.getVideoByUserAndVideoId(id, pid);
        res.json(video);
    } catch (error) {
...
const updateVideoOfUser = async (req, res) => {
    ...
    try {
        ...
        const updatedVideo = await videosService.updateVideoByUserAndVideoId(id, pid, updateData);
...
const deleteVideoOfUser = async (req, res) => {
    ...
    try {
        ...
        const deletedVideo = await videosService.deleteVideoByUserAndVideoId(id, pid);
...
const createVideo = async (req, res) => {
    ...
    try {
        ...
        const newVideo = await videosService.addVideo(videoData);
